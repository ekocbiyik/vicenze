...
import com.meyratech.vicenze.ui.components.navigation.tab.NaviTab;
...
public class AppBar extends Composite<FlexLayout> {
    ...
    private void initTabs(NaviTab... tabs) {
        ...
        addTab.addClickListener(e -> this.tabs.setSelectedTab(addClosableNaviTab("New Tab", HomeView.class)));
