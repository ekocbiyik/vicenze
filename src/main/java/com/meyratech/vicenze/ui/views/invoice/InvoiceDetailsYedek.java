...
@Route(value = "invoice-details2", layout = MainLayout.class)
@PageTitle(ViewConst.TITLE_INVOICE_DETAILS)
public class InvoiceDetailsYedek extends ViewFrame implements HasUrlParameter<Long> {
    ...
    @Autowired
    public InvoiceDetailsYedek(InvoiceServiceImpl invoiceService) {
    ...
    private Component createContent() {
        ...
        System.out.println(invoice.getProject().getProjectName());
